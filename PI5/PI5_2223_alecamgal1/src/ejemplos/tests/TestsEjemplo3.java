	...
	public static void main(String[] args) {
		List.of(1,2,3).forEach(num_test -> {
			...
			TestsPI5.tests(
				...
				GraphsPI5::alumnosBuilder,		//Referencia al Builder del grafo
				AlumnosVertex::greedyEdge,		//Referencia a la Función para la arista voraz
				SolucionAlumnos::of);			//Referencia al método factoria para la solución
		});
	}
