...
public class TestEjemplo2 {
	...
	//define tamaño minimo, maximo si es rec, iter. num de problemas distintos, mediciones. Numero de repeticiones.
	...
	//se cambia el tamaño maximo si se alcanza un numero y generamos el fichero
	...
	public static <E> void testTiemposEjecucion(Integer nMin, Integer nMax,
		...
		//guardamos el resultado en el ficherp
